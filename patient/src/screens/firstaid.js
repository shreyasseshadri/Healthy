...
Drive yourself only as a last resort, and realize that it places you and others at risk when you drive under these circumstances.</Text>
                ...
                <View style={styles.textbox}>
                    <Text>{'\u2022'}
                        ...
                        <Text > Approach the victims in a calm and composed manner. Discourage other helping citizens from handling the victims in a brashly as this can cause further damage. Shift the patient away from oncoming traffic, broken glass, leaking car fluids or any other hazardous material.</Text>
                    </Text>
                </View>
...
Drive yourself only as a last resort, and realize that it places you and others at risk when you drive under these circumstances.</Text>
                ...
                <View style={styles.textbox}>
                    <Text>{'\u2022'}
                        ...
                        <Text > Immobilize the cervical spine by using two wooden blocks on either side of the neck (do not disturb the spine and head by shaking them). Shaking the head & neck while shifting the victim may cause major damage and paralyze the patient completely.</Text>
                    </Text>
                </View>
                ...
                <View style={styles.textbox}>
                    <Text>{'\u2022'}
                        ...
                        <Text > Bleeding can be stemmed by applying continuous pressure to the open wound with a cloth, or tying the cloth gently around the injury. 
Inspect the limbs of the victim for any fractures, broken bone or other damage while being careful to not apply any undue pressure or force. Secure the broken limb by tying a small stick to either side of the limb with a cloth. </Text>
                    </Text>
                </View>
                ...
                <View style={styles.textbox}>
                    <Text>{'\u2022'}
                        ...
                        <Text >Check if they're breathing by tilting their head backwards and looking and feeling for breaths.
If they are breathing, move them onto their side and tilt their head back to keep their airway open.
Every few minutes, check they're still breathing and that their head remains tilted back. </Text>
                    </Text>
                </View>
            </ScrollView>
        );
